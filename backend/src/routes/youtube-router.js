...
const { getShortsOfChannel, getSuggestedShorts, getPopularShorts } = require('../controllers/shorts/shorts')
...
youtubeRouter.get('/shorts/suggested', getSuggestedShorts)
youtubeRouter.get('/shorts/popular', getPopularShorts)
