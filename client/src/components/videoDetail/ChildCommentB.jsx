...
const ChildCommentB = ({snippet, id}) => {
    const { authorThumbnail, textDisplay, authorText, publishedAt, likesCount, publishedTimeText } = snippet
    ...
    return (
        <div style={{ display: "flex", flexDirection: "row", height: "auto", padding: "6px", margin: "8px 0px 8px 0px" }}>
            <div style={{ height: "40px", width: "40px", padding: "5px" }}>
                <img src={authorThumbnail && authorThumbnail.length > 0 ? authorThumbnail[0].url : ""}
                    height="30px" width="30px" />
            </div>
            <div style={{ display: "flex", flexDirection: "column", marginLeft: "20px", height: "auto", width: "auto" }}>
                <div style={{ display: "flex", flexDirection: "row"}}>
                    <p style={{ color: "white", fontSize: "14px", fontWeight: "bold" }}>{authorText}</p>
                ...
                <div style={{ display: "flex", flexDirection: "row", paddingTop:"8px" }}>
                    <div style={{ display: "flex", flexDirection: "row" }}>
                        <LikeIcon/>
                        <p style={{ color: "white", fontSize: "13px", marginTop: "6px", marginLeft:"5px" }}>{likesCount}</p>
                    </div>
                </div>
